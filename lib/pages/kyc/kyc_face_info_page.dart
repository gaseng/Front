...
class KycFaceInfoPage extends StatelessWidget {
  const KycFaceInfoPage({Key? key}) : super(key: key);
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('images/kyc-big-2.png'))),
              ),
              SizedBox(height: 30.0),
              Column(
              ...
              Spacer(),
              GestureDetector(
                onTap: () => Get.toNamed('/kyc/face/film'),
