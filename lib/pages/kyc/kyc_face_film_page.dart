...
class KycFaceFilmPage extends StatelessWidget {
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text('얼굴 촬영하기', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold),),
                SizedBox(height: 8.0),
                Text('전면 카메라로 귀하의 얼굴을 촬영합니다.', textAlign: TextAlign.center, style: TextStyle(color: Colors.white),),
                Spacer(),
                GestureDetector(
                  onTap: () => Get.toNamed('/kyc/face-action/info'),
                  child: Stack(
